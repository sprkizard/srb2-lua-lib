...
* Desc: Button state management - Ever want an easy way to
...
local buttonstate_dupeprevent = false

addHook("PlayerThink", function(player)

		local mo = player.mo
		
		-- Avoid processing buttonstate multiple times per frame if multiple loaded addons have this code snippet in them!
		if player.buttonstate and not buttonstate_dupeprevent then return end
		buttonstate_dupeprevent = true
